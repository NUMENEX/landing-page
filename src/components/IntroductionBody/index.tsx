    ...
    <div>
      <div className="px-20 md:px-40 py-5 gap-20">
        <div className="flex justify-center mb-5">
          <div className=" flex flex-row p-1 bg-purple-100  text-purple-800 rounded-md gap-2 ">
            <img src="src/assets/svg/star-golden-logo.svg"></img>
            <div>First AI powered market making and trading platform</div>
          </div>
        </div>
        ...
        <div className="pt-10 text-center lg:text-lg">
      ...
      <div className="flex flex-row  gap-5 justify-center  ">
        <div className="primaryButton">Start trading with AI now</div>
